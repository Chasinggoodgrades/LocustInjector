...
integer TotalCommands= 0
        ...
        // integer TEMP_INT_ACHES = 0
        // real TEMP_REAL_ACHES = 0.0
        // unit array Escapers
...
force CommandsManager___ResolvedForce= CreateForce()
        ...
        // private group HeroFindGroup = CreateGroup()
        // private timer HeroFindTimer = CreateTimer()
        // private integer TotalHumanPlayers = 0
        // private integer FoundHeroCount = 0
...
function ResolvePlayerIdArray takes string arg returns nothing
    ...
    // ================================================================
    // private function CountHumanPlayers takes nothing returns nothing
    //     local integer i = 0
    ...
    // private function TryFindHeroes takes nothing returns nothing
    //     local integer i = 0
    //     local player p
    //     local unit u
    //     local unit found
    ...
    //             if Escapers[GetConvertedPlayerId(p)] == null then
    //                 set found = null
    ...
    function CommandsManager___InitCommands takes nothing returns nothing
        ...
        call RegisterCommand(""zoom"" , """" , COMMAND_TIER_ALL , ""[zoom]"" , ""Zooms your camera out to the passed value"" , function CommandsManager___Commands_Zoom)
        ...
        // Hero Finder -- start polling for player heroes
        //call CountHumanPlayers()
        //call TimerStart(HeroFindTimer, 1.00, true, function TryFindHeroes)
    endfunction
