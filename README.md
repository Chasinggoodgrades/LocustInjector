...
A .NET tool that automatically injects the Locust ability into Warcraft III map files (.w3x/.w3m), making all units unselectable and invisible on the minimap.

## What is Locust?

Locust is a special ability in Warcraft III that makes units:
- Unselectable
- Invisible on the minimap
- Unable to be targeted by spells
- Ideal for visual effects, doodads, or background units

This tool automates the process of adding Locust functionality to all units in your maps by modifying the JASS script directly.
...
2. **Injection**: Adds trigger code that:
   ...
   - Adds/removes the Locust ability to units entering the map
   - Handles unit spawning events
